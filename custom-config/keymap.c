...
[_ADJUST] = LAYOUT( \
  _______, _______, _______, _______, _______, _______,                     RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, KC_BSPC, \
  XXXXXXX,  XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_4,    KC_5,              KC_1,    KC_2,    KC_3,    KC_0,    KC_0,    RGB_VAD, \
