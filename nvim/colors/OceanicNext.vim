...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('IncSearch',                          s:yellow, s:green, 'NONE',      '')
  ...
  call s:hi('Conditional',                        s:purple, '',       s:bold,          '')
  call s:hi('Constant',                           s:orange, '',       s:bold,          '')
  ...
  call s:hi('Keyword',                            s:yellow, '',       s:italic,          '')
  ...
  call s:hi('TSKeyword',                          s:yellow, '',       s:italic,          '')
  ...
  call s:hi('htmlTag',                            s:cyan,   '',       s:bold,          '')
  ...
  call s:hi('jsonKeyword',                        s:yellow,  '',       '',          '')
